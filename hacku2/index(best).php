...
{
	$field=explode(':',$event);
	echo '<a class="listItem oddRow" href="home.php#'.$e.$field[1].'" target="_parent" >'.$e. $field[1].'</a>';
	$e++;
}	  
